...
class NetworkEngine:
    ...
    def set_arpanet_topology(self):
        ...
        #    self.bws[host] = random.randint(5, 25) #10-30
        #print(self.bws)
        ...
        #self.bws = {'H21': 20, 'H1': 21, 'H22': 16, 'H2': 11, 'H23': 10, 'H3': 26, 'H24': 25, 'H4': 23, 'H25': 29, 'H8': 27, 'H26': 23, 'H11': 12, 'H27': 13, 'H12': 14, 'H28': 11, 'H13': 28, 'H29': 19, 'H16': 11, 'H30': 26, 'H17': 17, 'H31': 17, 'H18': 21, 'H32': 24, 'H19': 12, 'H33': 27, 'H20': 18, 'H6': 22, 'H5': 29, 'H7': 16, 'H10': 10, 'H9': 27, 'H14': 18, 'H15': 16}
        self.bws = {'H21': 7, 'H1': 10, 'H22': 22, 'H2': 7, 'H23': 8, 'H3': 12, 'H24': 12, 'H4': 20, 'H25': 7, 'H8': 13, 'H26': 13, 'H11': 25, 'H27': 5, 'H12': 9, 'H28': 13, 'H13': 11, 'H29': 21, 'H16': 9, 'H30': 14, 'H17': 20, 'H31': 9, 'H18': 19, 'H32': 12, 'H19': 21, 'H33': 25, 'H20': 14, 'H6': 6, 'H5': 19, 'H7': 25, 'H10': 6, 'H9': 5, 'H14': 10, 'H15': 21}
        self.calculate_paths()
...
def generate_traffic_sequence_service_provider(network=None):
    ...
    """for host in start:
        ...
        bws[host] = random.randint(20, 50)
        for i in range(30):
            dst = network.get_random_dst(host, end)
            dsts = communications.get(host, [])
            #print("\n dsts: ", dsts)
            dsts.append(dst)
            communications[host] = dsts
            #print("communications host: ", communications[j][host])
        #print("communications host: ", communications[j])
    #ist_all_communications.append(communications)
    #communications = {}"""
